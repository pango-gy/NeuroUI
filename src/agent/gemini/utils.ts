        ...
        case ServerGeminiEventType.Finished:
          {
            ...
            const finishedValue = (event as unknown as { value: { usageMetadata?: unknown } }).value;
            onStreamEvent({ type: event.type, data: finishedValue });
            // Capture usageMetadata for return
            capturedUsageMetadata = finishedValue?.usageMetadata;
          }
          break;
